...
rgbaColorPicker.prototype = {
	...
	classID:			Components.ID("{de710bf1-b4b6-4ef5-ac8a-beb4ea958e81}"),
	...
	pickColorWithPositioning: function(hexColor, screenX, screenY) {
		...
		var savedColors = prefs.getString('colorpicker.savedColors');
															...
															aScreenX, aScreenY)
	{
		...
		if (args.retval) {
			// Remember the last color mode used, for next time.
			prefs.setStringPref("colorpicker.colorMode", args.colorMode);
			prefs.setString("colorpicker.savedColors", args.savedColors);
